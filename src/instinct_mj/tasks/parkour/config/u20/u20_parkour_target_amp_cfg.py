...
# motion data files. V11 uses a different order here vs tracking body_names;
# U20 follows the same convention as V11 (base, upper body, legs).
motion_reference_cfg = MotionReferenceManagerCfg(
    ...
    # pairs: (1,2) shoulder_roll, (3,4) elbow, (5,6) wrist_yaw,
    #        (7,8) hip_roll, (9,10) knee, (11,12) foot
...
def instinct_u20_parkour_amp_env_cfg(
    *,
    play: bool = False,
...
def instinct_u20_parkour_amp_final_cfg(
    *,
    play: bool = False,
) -> ManagerBasedRlEnvCfg:
